...
static void mavlink_test_tilt_angle_setpoint(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_TILT_ANGLE_SETPOINT >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_tilt_angle_setpoint_t packet_in = {
        963497464,45.0,73.0,101.0,129.0
    };
    mavlink_tilt_angle_setpoint_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_TILT_ANGLE_SETPOINT_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_TILT_ANGLE_SETPOINT_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_tilt_angle_setpoint_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_tilt_angle_setpoint_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_tilt_angle_setpoint_pack(system_id, component_id, &msg , packet1.time_boot_ms , packet1.tilt_fl , packet1.tilt_fr , packet1.tilt_rl , packet1.tilt_rr );
    mavlink_msg_tilt_angle_setpoint_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_tilt_angle_setpoint_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_boot_ms , packet1.tilt_fl , packet1.tilt_fr , packet1.tilt_rl , packet1.tilt_rr );
    mavlink_msg_tilt_angle_setpoint_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_tilt_angle_setpoint_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_tilt_angle_setpoint_send(MAVLINK_COMM_1 , packet1.time_boot_ms , packet1.tilt_fl , packet1.tilt_fr , packet1.tilt_rl , packet1.tilt_rr );
    mavlink_msg_tilt_angle_setpoint_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("TILT_ANGLE_SETPOINT") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_TILT_ANGLE_SETPOINT) != NULL);
#endif
}
...
static void mavlink_test_control_surface_cmd(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_CONTROL_SURFACE_CMD >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_control_surface_cmd_t packet_in = {
        963497464,45.0,73.0,101.0,129.0
    };
    mavlink_control_surface_cmd_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_boot_ms = packet_in.time_boot_ms;
        packet1.left_aileron = packet_in.left_aileron;
        packet1.right_aileron = packet_in.right_aileron;
        packet1.left_ruddervator = packet_in.left_ruddervator;
        packet1.right_ruddervator = packet_in.right_ruddervator;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_CONTROL_SURFACE_CMD_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_CONTROL_SURFACE_CMD_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_control_surface_cmd_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_control_surface_cmd_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_control_surface_cmd_pack(system_id, component_id, &msg , packet1.time_boot_ms , packet1.left_aileron , packet1.right_aileron , packet1.left_ruddervator , packet1.right_ruddervator );
    mavlink_msg_control_surface_cmd_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_control_surface_cmd_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_boot_ms , packet1.left_aileron , packet1.right_aileron , packet1.left_ruddervator , packet1.right_ruddervator );
    mavlink_msg_control_surface_cmd_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_control_surface_cmd_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_control_surface_cmd_send(MAVLINK_COMM_1 , packet1.time_boot_ms , packet1.left_aileron , packet1.right_aileron , packet1.left_ruddervator , packet1.right_ruddervator );
    mavlink_msg_control_surface_cmd_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("CONTROL_SURFACE_CMD") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_CONTROL_SURFACE_CMD) != NULL);
#endif
}
...
static void mavlink_test_development(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_tilt_angle_setpoint(system_id, component_id, last_msg);
    mavlink_test_tilt_status(system_id, component_id, last_msg);
    mavlink_test_control_surface_cmd(system_id, component_id, last_msg);
}
